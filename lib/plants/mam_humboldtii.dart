...
class MamHumboldtii extends StatefulWidget {
  @override
  State<MamHumboldtii> createState() => _MamHumboldtiiState();
}

class _MamHumboldtiiState extends State<MamHumboldtii> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection("MamHumboldtii ").snapshots(),
  ...
  Future<void> addHumboldtii() async {
