...
class GymBruchii extends StatefulWidget {
  @override
  State<GymBruchii> createState() => _GymBruchiiState();
}

class _GymBruchiiState extends State<GymBruchii> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection("GymBruchii").snapshots(),
  ...
  /////////////////// Add My Plants ///////////////////////////
  String name = "Gymnocalycium Bruchii";
  String oname = "บลูชิ";
