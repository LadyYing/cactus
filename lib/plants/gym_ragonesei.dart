...
class GymRagonesei extends StatefulWidget {
  @override
  State<GymRagonesei> createState() => _GymRagoneseiState();
}

class _GymRagoneseiState extends State<GymRagonesei> {
                        ...
                        child: Column(
                          children: [
                            ...
                            ListTile(
                              ...
                              title: const Text('การเพาะเมล็ด', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
