...
class GymDamsii extends StatefulWidget {
  @override
  State<GymDamsii> createState() => _GymDamsiiState();
}

class _GymDamsiiState extends State<GymDamsii> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection("GymDamsii").snapshots(),
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            ListTile(
                              ...
                              subtitle: Text(document["des"], style: const TextStyle(fontSize: 15),),
                            ),
                          ],
                        ),
                      ),
